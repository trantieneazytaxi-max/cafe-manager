    ...
    const sidebarHtml = `
        <aside class="sidebar" id="mainSidebar">
            ...
            <div class="sidebar-footer">
                ...
                <a href="../../dashboard/profile/html/profile.html" class="user-info" style="text-decoration: none; color: inherit; display: flex; align-items: center; gap: 12px; padding: 10px; border-radius: 12px; transition: background 0.3s; width: 100%;">
